        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("061be113-13f2-40eb-9c19-e405cc215e4a"), "A defendant is a person accused of a crime.", "General", new DateTime(2026, 5, 15, 17, 45, 31, 173, DateTimeKind.Utc).AddTicks(2525), "Law", true, "defendant", "davalı" },
                    { new Guid("0c3cc2b1-0633-46d6-bd62-3d72d92d2988"), "To debug means to find and fix errors in code.", "General", new DateTime(2026, 5, 15, 17, 45, 31, 173, DateTimeKind.Utc).AddTicks(2483), "Software", true, "debug", "hata ayıklamak" },
                    ...
                    { new Guid("6a53fbf4-61b6-4f88-a842-f0504cbb8dff"), "Prognosis is the likely outcome of a disease.", "General", new DateTime(2026, 5, 15, 17, 45, 31, 173, DateTimeKind.Utc).AddTicks(2509), "Medicine", true, "prognosis", "hastalık gidişi" },
                    ...
                    { new Guid("ed9e1d2f-12f4-45bb-84e0-7cc6252fdb30"), "Diagnosis is the identification of a disease or condition.", "General", new DateTime(2026, 5, 15, 17, 45, 31, 173, DateTimeKind.Utc).AddTicks(2504), "Medicine", true, "diagnosis", "tanı" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("454b4275-6c87-4c55-ad76-0837d44993a5"), "To debug means to find and fix errors in code.", "General", new DateTime(2026, 5, 14, 20, 20, 46, 634, DateTimeKind.Utc).AddTicks(5904), "Software", true, "debug", "hata ayıklamak" },
                    ...
                    { new Guid("5d090354-b672-4635-a76d-93a01e782b29"), "Diagnosis is the identification of a disease or condition.", "General", new DateTime(2026, 5, 14, 20, 20, 46, 634, DateTimeKind.Utc).AddTicks(5937), "Medicine", true, "diagnosis", "tanı" },
                    ...
                    { new Guid("a985bcd6-f85f-42c2-b4fc-fe5a80a32490"), "Prognosis is the likely outcome of a disease.", "General", new DateTime(2026, 5, 14, 20, 20, 46, 634, DateTimeKind.Utc).AddTicks(5960), "Medicine", true, "prognosis", "hastalık gidişi" },
                    ...
                    { new Guid("d8bc78d6-767c-44b1-9c49-8c8ea0d70983"), "A defendant is a person accused of a crime.", "General", new DateTime(2026, 5, 14, 20, 20, 46, 634, DateTimeKind.Utc).AddTicks(5976), "Law", true, "defendant", "davalı" },
