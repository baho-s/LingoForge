    ...
    public partial class AddPredefinedWordsTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("084e7fe8-13c8-4773-9b85-eb054b6b549a"), "Diagnosis is the identification of a disease or condition.", "General", new DateTime(2026, 5, 13, 20, 19, 50, 346, DateTimeKind.Utc).AddTicks(9976), "Medicine", true, "diagnosis", "taný" },
                    { new Guid("16b6999a-d974-48f5-9cdd-2a8221be9b39"), "To debug means to find and fix errors in code.", "General", new DateTime(2026, 5, 13, 20, 19, 50, 346, DateTimeKind.Utc).AddTicks(9928), "Software", true, "debug", "hata ayýklamak" },
                    ...
                    { new Guid("20fd5b19-adb8-49df-9786-b3118ae0c031"), "Prognosis is the likely outcome of a disease.", "General", new DateTime(2026, 5, 13, 20, 19, 50, 346, DateTimeKind.Utc).AddTicks(9983), "Medicine", true, "prognosis", "hastalýk gidiþi" },
                    ...
                    { new Guid("72d2cf05-3dce-4b16-b125-ada4365580ac"), "A defendant is a person accused of a crime.", "General", new DateTime(2026, 5, 13, 20, 19, 50, 347, DateTimeKind.Utc).AddTicks(30), "Law", true, "defendant", "davalý" },
