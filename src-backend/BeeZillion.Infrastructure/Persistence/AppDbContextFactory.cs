...
public sealed class AppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
{
    public AppDbContext CreateDbContext(string[] args)
    {
        ...
        {
            apiSettings = Path.Combine(basePath, "src", "BeeZillion.API", "appsettings.json");
            apiDevSettings = Path.Combine(basePath, "src", "BeeZillion.API", "appsettings.Development.json");
        }
